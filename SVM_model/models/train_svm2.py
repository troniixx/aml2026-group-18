...
from SVM_model.data.preprocess1 import build_dataset, build_dataset_other
from SVM_model.config import DATA_DIR_TRAIN, DATA_DIR_TEST, MODEL_PATH2, CLASSES, NEW_DATA_DIR_TRAIN, NEW_DATA_DIR_VAL, NEW_DATA_DIR_TEST, DATA_DIR_OWN
